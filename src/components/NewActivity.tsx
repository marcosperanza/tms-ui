    ...
    render() {
        return (
            <div className="flex flex-row justify-content-end flex-wrap mt-6">
                ...
                <Accordion id={'open-new-activity-dialogue'} activeIndex={0} className="w-full">
                    <AccordionTab  header="Add Task">
                        <div id={'newActivityDialogue'}>
                            <div className="mt-4">
                            ...
                            <div className="mt-4">
                                ...
                                <div className={'flex flex-row flex-nowrap md:hide'}>
                                    ...
                                    <Button id={'calendar-btn'}
                                            className={'no-round-border-left'}
                                            icon="pi pi-calendar"
                            ...
                            <Button label="Save"
                                    ...
                                    onClick={this.addNewActivity}/></div>
